...
- `Open-GeneXusKbHeadless.ps1`
  ...
  - saída esperada: `status`, `level`, `exitCode`, `executionEvidence`, `blockingReasons`, `observedContext`, `warnings`, `strategyTrace`, `msBuildExitCode` top-level como compatibilidade transitória quando existir, e caminhos dos logs
