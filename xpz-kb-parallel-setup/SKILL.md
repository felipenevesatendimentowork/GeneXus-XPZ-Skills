...
8.g4 Consolidacao de handoff via `Test-*KbSetupAudit.ps1` (executar imediatamente antes de 8.h quando a intencao for `auditar_setup`):
    ...
    - Quando a saida incluir ambos `INVENTORY_SHORT_NAMING` e `INVENTORY_GAPS` (separados por ` | `): tratar os dois conjuntos conforme as regras acima — SHORT_NAMING como CUSTOMIZADO com rename, GAPS como AUSENTE com criacao
