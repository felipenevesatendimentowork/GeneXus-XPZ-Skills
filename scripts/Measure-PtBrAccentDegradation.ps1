...
$null = $sb.AppendLine('- **Ambiguas (teto solto)** = `esta/tem/vem/so`, contadas sem confirmacao; superestimam (forma sem acento muitas vezes valida; `so` colide com ingles). `e/e` nao e contado.')
