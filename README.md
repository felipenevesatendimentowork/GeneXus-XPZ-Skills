...
- para diagnostico compacto de Panel e WebPanel, preferir `scripts/Get-GeneXusObjectSummary.ps1` (com bloco `webpanel` para WebPanel classico) e, para Panel, `scripts/Compare-GeneXusPanelShape.ps1`, antes de despejar XML/CDATA completo; para adicionar botao a WebPanel, preferir `scripts/Add-GeneXusButton.ps1` (insercao cirurgica, fail-closed em tabela Responsive com breakpoints)
...
- para diagnostico compacto de Panel y WebPanel, preferir `scripts/Get-GeneXusObjectSummary.ps1` (con bloque `webpanel` para WebPanel clasico) y, para Panel, `scripts/Compare-GeneXusPanelShape.ps1`, antes de volcar XML/CDATA completo; para agregar un boton a WebPanel, preferir `scripts/Add-GeneXusButton.ps1` (insercion quirurgica, fail-closed en tabla Responsive con breakpoints)
...
- for compact Panel and WebPanel diagnosis, prefer `scripts/Get-GeneXusObjectSummary.ps1` (with a `webpanel` block for classic WebPanel) and, for Panel, `scripts/Compare-GeneXusPanelShape.ps1`, before dumping full XML/CDATA; to add a button to a WebPanel, prefer `scripts/Add-GeneXusButton.ps1` (surgical insertion, fail-closed on a Responsive table with breakpoints)
