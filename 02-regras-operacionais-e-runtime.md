...
- `Evidência direta`: motores `Sync-GeneXusXpzToXml.ps1` e inventario aceitam `-DiscoveryReportPath`, `-ParallelKbRoot`, `-CatalogOverridePath` e agregam amostras (`name`, `parent`, `parentType`, snippet XML) em falha ou JSON de triagem.
