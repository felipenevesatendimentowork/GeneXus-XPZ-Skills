...
- `Regra operacional`: a validacao automatica de parse PowerShell da base e `scripts/Test-PsScriptsParse.ps1`, tambem executada por `.github/workflows/parse-ps-scripts.yml`; ela deve cobrir `scripts/*.ps1` e `.example.ps1` das skills fora de `historico/` sob o contrato `pwsh` 7.4+.
