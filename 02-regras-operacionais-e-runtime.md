...
- `Regra operacional`: o gate de regeneracao ampla (`-AllowWideRebuild`) e independente do gate de reorg (`-AllowReorg`): autorizar um nao autoriza o outro. Cada operacao ampla exige sua propria confirmacao por frase exata especifica.
