...
- `Regra operacional`: Specify limpo do objeto ou Rebuild All do environment ANTES de mexer no XML. Se o sintoma persistir apos a regeneracao limpa, ai sim investigar o XML.
