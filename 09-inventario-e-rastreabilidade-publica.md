...
- `Evidência direta`: `13-revisao-pre-push.md` concentra a rotina pre-push autoritativa (mecanico, semantica, paridade motor↔doc, veredicto); `AGENTS.md` apenas aponta para esse arquivo.
