...
- `Evidência direta`: `scripts/Test-GeneXusImportPackageObjectInventorySelfTest.ps1` valida inventario em XML e `.xpz` sintetico (delta seletivo, modulos de sistema e atributos top-level).
